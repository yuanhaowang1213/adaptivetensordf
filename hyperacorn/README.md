...
```shell
conda create -y -n hyperquad python=3.8.1
conda activate hyperquad
...
```shell
conda activate hyperquad
git clone git@github.com:darglein/hyperquad.git
cd hyperquad
git submodule update --init --recursive --jobs 0
...
conda create -y -n hyperquad python=3.8
conda activate hyperquad

# conda install -y cudatoolkit-dev=11.2.2 -c conda-forge

export TMPDIR=/ibex/scratch/wangy0k/mycode/tmp
conda install cudnn=8.2.1.32 cudatoolkit=11.2 cudatoolkit-dev=11.2.2 -c conda-forge

conda install -y cudnn cudatoolkit cudatoolkit=11.2 -c conda-forge
...
export CMAKE_PREFIX_PATH=${CONDA_PREFIX:-"$(dirname $(which conda))/../"}
export CC=/sw/csi/gcc/7.5.0/el7.9_binary/bin/gcc
export CXX=/sw/csi/gcc/7.5.0/el7.9_binary/bin/g++
export CUDAHOSTCXX=/sw/csi/gcc/7.5.0/el7.9_binary/bin/g++
...
export Torch_DIR=/home/wangy0k/anaconda3/envs/hyperquad/lib/python3.8/site-packages/torch
export CC=/sw/csi/gcc/7.5.0/el7.9_binary/bin/gcc
export CXX=/sw/csi/gcc/7.5.0/el7.9_binary/bin/g++
export CUDAHOSTCXX=/sw/csi/gcc/7.5.0/el7.9_binary/bin/g++
